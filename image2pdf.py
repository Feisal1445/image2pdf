...
# create GUI
root = tk.Tk()
root.title("Convert your Images to PDF")
select_images_btn = tk.Button(root, text="Select an Images", command=select_images)
select_pdf_btn = tk.Button(root, text="Select PDF file", command=select_pdf)
